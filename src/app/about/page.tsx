...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "ilham.m129150@gmail",
    href: "mailto:ilham.m129150@gmail",
    icon: <FaEnvelope height={"50px"} />,
  },
  {
    name: "Phone",
    content: "082129174258",
    href: "tel:082129174258",
    icon: <FaPhone height={"50px"} />,
  },
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com",
    content: "/Ilham Nur salam",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Ilham</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Ilham, a student with a strong interest in web development.
              i'm focused on learning modern tecnologies,building real project,and preparing 
              myself for the tech industry.progres over excuses
            </p>
            <p className="mb-10">
              When I&apos;m not coding, you can find me [mobile legends], 

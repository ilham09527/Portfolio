...
const projects: Project[] = [
  ...
  {
    id: "Alam Nusa",
    category: "kuningan's destination natural beauty",
    title: "Alam Nusa",
    src: "/assets/projects-screenshots/alam_nusa/4.png",
    screenshots: ["1.png", "2.png", "3.png", "4.png", "5.png"],
    live: "https://webdesign-casper-b-technoversary25.vercel.app/#destinations",
    skills: {
      frontend: [
        PROJECT_SKILLS.js,
        PROJECT_SKILLS.html,
    ...
    get content(): JSX.Element {
      return (
        <div>
          <TypographyP className="font-mono ">
           Alam Nusa is the website showcase stunning kuningan destinations from from crystal-clear lakes like Telaga biru cicerem,
           refreshing waterfalls such as a Curug putri,to the adventurous height of Mount ciremai.the destinations section help
           users explore and discover places based on different travel styles,making it easy to plan both relaxing trips and thriling adventures 
          </TypographyP>
          <ProjectsLinks live={this.live} repo={this.github} />
          <p className="font-mono mb-2 mt-4">
           From the moment you arrive,explore curated destinations with instant map accses.
          </p>
          <SlideShow images={[`${BASE_PATH}/alam_nusa/4.png`]} />
          <TypographyH3 className="my-4 ">destination</TypographyH3>
          <p className="font-mono mb-2">
            discover amazing destinations across indonesia.
            click to see more to each location on the map
          </p>
          <SlideShow
            images={[
              `${BASE_PATH}/alam_nusa/5.png`,
              `${BASE_PATH}/alam_nusa/1.png`,
            ]}
          />

...
export const EXPERIENCE: Experience[] = [
  {
    ...
    company: "sofware class",
    description: [
      "Developed several web-based projects as part of school assignments and self-learning.",
      "Designed simple databases and practiced writing efficient queries.",
      "Built responsive user interfaces using HTML, CSS, Tailwind, and React.",
    ],
    skills: [
      SkillNames.HTML,
      SkillNames.CSS,
  ...
  },
  {
    ...
    description: [
      "Explored modern web development tools such as Docker and Next.js at a beginner level.",
      "Practiced deploying applications using cloud platforms for learning purposes.",
      "Focused on understanding best practices in code structure and maintainability.",
    ],
    skills: [
      SkillNames.NEXTJS,
      SkillNames.NODEJS,
